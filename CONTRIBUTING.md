...
# Reporting issues
Please use [official Khulnasoft support website](https://support.khulnasoft.com) to report any issues. Our technical support team will work together with you to resolve an issue, or pass it on to our engineers for resolution.

You can find recommended information to include in the ticket on the [technical support guide page](https://support.khulnasoft.com/hc/en-us/articles/5930557657885-Khulnasoft-Technical-Support-Guide).
...
We are thrilled that you are interested in contributing code changes! Because this project is part of Khulnasoft’s overall software offering, we want to make sure that your contribution aligns with our vision and product strategy, so please reach out to us before submitting a pull request. If you’re thinking of contributing a new feature, contact [our support](https://support.khulnasoft.com) with a detailed explanation of your planned contribution and we'll be happy to discuss it with you. If you’re thinking of contributing a bug fix, we’d still like you to raise a support ticket first, as it’s possible we may already be working on a fix.
...
As part of the PR process, you'll need to sign a Contributor License Agreement (CLA). It is an automated process and you'll only need to do it once, when contributing first time. You won't need to sign it in future when contributing to other Khulnasoft projects.
