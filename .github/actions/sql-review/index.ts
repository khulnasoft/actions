  ...
  try {
    ...
    for (const file of sqlFiles) {
      ...
      responseData.advices.forEach((advice: { status: string; line: any; column: any; title: any; code: any; content: any; }) => {
        const annotation = `::${advice.status} file=${file},line=${advice.line},col=${advice.column},title=${advice.title} (${advice.code})::${advice.content}. https://www.khulnasoft.com/docs/reference/error-code/advisor#${advice.code}`;
