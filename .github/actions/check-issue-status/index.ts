...
async function run(): Promise<void> {
  ...
  //   "uid": "129",
  //   "title": "[khulnasoft/ci-example#6] chore: add migration files",
  //   "description": "Triggered by https://github.com/khulnasoft/ci-example/pull/6 chore: add migration files",
  ...
  //     {
  //       "status": "APPROVED",
  //       "principal": "users/ci@service.khulnasoft.com"
  //     }
  //   ],
  //   "approvalTemplates": [
  //     {
  ...
  //   "subscribers": [],
  //   "creator": "users/ci@service.khulnasoft.com",
  ...
  //   "releasers": [
  //     "roles/projectOwner",
  //     "users/ci@service.khulnasoft.com"
  //   ],
      ...
      for (const task of stage.tasks) {
        ...
        if (matchedChange) {
          if (matchedChange.content == actualRolloutContent) {
            ...
            // This means the PR content is different from the Khulnasoft issue content.
            // It could be that Khulnasoft issue content is manually changed by someone.
          ...
          // This means Khulnasoft contains a task not found in the PR
